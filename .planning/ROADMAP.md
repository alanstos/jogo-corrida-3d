...
- [x] **Phase 3: Game Feel** — Turbo, partículas, camera shake, haptic + cleanup console.log (completed 2026-05-27)
...
- [x] 03-04-PLAN.md — Camera shake offset on collision (~300ms exponential decay), additive to lerp target, no physics coupling (FEEL-03)
- [x] 03-05-PLAN.md — navigator.vibrate guarded helper, 50ms on turbo and 100ms on collision, silent fallback on iOS/Firefox 129+ (FEEL-04)
